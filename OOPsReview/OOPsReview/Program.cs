...
void SaveAsJson(Person me, string pathname)
{
    ...
    //Json is very good at using objects and properties, however it needs
    //help/prompting to work better with field: option IncludeFields
    ...
    try
    {
        ...
        //use WriteAllText here because therte is ONLY a SINGLE line of text
